...
<head>
    <meta charset="UTF-8">
    <title><?php echo \Wasf\View\Blade::yield('title'); ?></title>
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle d-flex align-items-center gap-2" href="#" data-bs-toggle="dropdown">
                        ...
                        <?php if (auth()->user()->photo): ?>
                            <img src="/uploads/profile/<?php echo htmlspecialchars((string)(auth()->user()->photo ?? ""), ENT_QUOTES, "UTF-8"); ?>" class="avatar-sm shadow-sm">
                        <?php else: ?>
                            <div class="avatar-sm bg-primary text-white d-flex justify-content-center align-items-center"
                                ...
                                <?php echo htmlspecialchars((string)(strtoupper(substr(auth()->user()->name, 0, 1)) ?? ""), ENT_QUOTES, "UTF-8"); ?>
                            </div>
                        <?php endif; ?>

                        <span class="fw-semibold"><?php echo htmlspecialchars((string)(auth()->user()->name ?? ""), ENT_QUOTES, "UTF-8"); ?></span>
                    </a>
